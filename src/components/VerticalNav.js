...
>>>>>>> 8915c9fb3aa889ef77556f39e3d5a63159342d4e
  return (
...
=======
        {isSignedIn
          ? (
            <button type="button" onClick={() => { setClickedIndex(1); navigate('/'); }} className="bg-transparent borderless w-100 text-start">
              <h5 className={`${clickedIndex === 1 && 'sidebar-item-active '} py-2 fw-bold ps-2`}>SIGN IN</h5>
            </button>
          )
          ...
          : (
            <>
              ...
              <button type="button" onClick={() => { setClickedIndex(5); navigate('/'); }} className="bg-transparent borderless w-100 text-start">
                <h5 className={`${clickedIndex === 5 && 'sidebar-item-active '} py-2 fw-bold ps-2`}>SIGN OUT</h5>
              </button>
            </>
          )}
